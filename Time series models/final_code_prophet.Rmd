...
fichier <- "C:/Users/mokom/OneDrive/Bureau/Projet_times_series/final_database.csv"
...
```{r}
# Étape 6 : Statistiques de performance
# Calculer les statistiques pour l'horizon de test
actual <- test$Close
predicted <- forecast$yhat

# Calcul du RMSE, MAE, et MAPE
...
```{r}
# Étape 7 : Afficher les coefficients des variables exogènes
...
# Tracer une contribution individuelle
ggplot(forecast, aes(x = ds, y = GDP)) +
  geom_line(color = 'blue') +
  labs(title = 'Contribution de UNR_us',
